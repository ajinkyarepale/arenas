...
export const metadata: Metadata = {
  title: 'How to trade',
  description:
    'Everything a first-time trader needs before an Arenas event: what YES and NO mean, how the price moves, how you win points, and what to do in your first round.',
};
    ...
    <SiteShell>
      <div className="flex flex-col gap-10">
        ...
        <Section title="What you are actually buying">
          <p>
            You are buying <Strong>shares</Strong>. A share is a claim that pays{' '}
            <Strong>exactly 1 point</Strong> if your side wins, and{' '}
            <Strong>0 points</Strong> if it loses. That is the whole contract.
          </p>
          <p>
            So the price of a share is always somewhere between 0 and 1 point, and it is
            usually written as a percentage. If YES costs <Mono>62%</Mono>, you pay 0.62
            points for something that pays 1 point if the candle closes green.
          </p>
          <Panel className="p-5">
            <p className="text-sm font-semibold">A worked example</p>
            <ul className="mt-3 flex flex-col gap-2 text-sm text-fg-muted">
              <li>You stake <Mono>50 points</Mono> on YES while YES is trading at 62%.</li>
              <li>That buys you roughly <Mono>78 shares</Mono> (50 ÷ 0.62 ≈ 78).</li>
              <li>
                The candle closes green. Your 78 shares pay 1 point each:{' '}
                <span className="font-semibold text-yes">+78 points</span>, for a profit of
                28.
              </li>
              <li>
                The candle closes red instead. The shares pay nothing:{' '}
                <span className="font-semibold text-no">−50 points</span>.
              </li>
            </ul>
          </Panel>
        ...
        <Section title="Your first round: what to actually do">
          <ol className="flex flex-col gap-3">
            {[
              ...
              'Stake small to start — 10 or 25 points. You have twelve rounds; there is no prize for going all-in on round one.',
        ...
        <Section title="Mistakes people make every single event">
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <Callout tone="warn" title="Chasing the crowd at 90%">
              At 90% you risk 0.9 points to win 0.1. The crowd being right nine times out of
              ten is exactly break-even.
            </Callout>
        ...
        <p className="text-xs leading-relaxed text-fg-faint">
          Arenas is educational. Every market settles in virtual points with no cash value,
          there is nothing to deposit or withdraw, and nothing here is investment advice.
        </p>
      </div>
    </SiteShell>
  );
