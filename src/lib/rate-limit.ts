...
/** OTP requests: 5 codes per 15 minutes per email, min 30s between sends. */
...
/** OTP guesses: 10 attempts per 10 minutes per email+IP. */
export const OTP_VERIFY_RULE: RateLimitRule = {
  limit: 10,
  windowMs: 10 * 60_000,
};
