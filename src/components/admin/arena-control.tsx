  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
        <Panel className="p-5">
          ...
          <div className="mt-5 grid grid-cols-3 gap-3 border-t border-line pt-4">
            ...
            <MiniStat
              label="Round volume"
              value={<Arcs value={round?.volume ?? 0} decimals={0} />}
            />
          </div>
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        />
        <Stat label="Recent volume" value={<Arcs value={totalVolume} decimals={0} />} />
        <Stat
          label="Arcs in play"
          value={
            <Arcs
              value={participants.reduce((sum, p) => sum + p.balance, 0)}
              decimals={0}
            />
          }
        />
